...
if 'handler' in __vc_variables or 'Handler' in __vc_variables:
    ...
    def vc_handler(event, context):#  1 if 'handler' in __vc_variables or 'Handler' in __vc_variables:
    ...
    if (
        ...
        def vc_handler(event, context):#  2 elif 'app' in __vc_variables:
            payload = json.loads(event['body'])
        ...
        def vc_handler(event, context):#  3  elif 'app' in __vc_variables:
            payload = json.loads(event['body'])
